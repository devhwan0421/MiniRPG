...
```Bash
git clone https://github.com/devhwan0421/MiniRPG.git
```

### **2) 프로젝트 추가 및 실행**
1. Unity Hub를 실행
2. [Add] (또는 열기 > 디스크에서 프로젝트 추가) 
버튼을 클릭
3. 클론 받은 폴더를 선택하여 리스트에 추가
4. Editor 버전 확인: Unity 6000.0.42f1

### **3) 메인 Scene 실행**
- 프로젝트가 열리면 Assets/Scenes/ 폴더 내의 `Login` 씬을 더블 클릭해 열기
- Play 버튼을 눌러 테스트
